...
## Cleaning Data Steps ([back to top](#costing-analyzer))
...
#### Importing the data ([back to top](#costing-analyzer))
...
#### Standardize column names ([back to top](#costing-analyzer))
...
#### Standardize data values ([back to top](#costing-analyzer))
...
#### Standardize dates ([back to top](#costing-analyzer))
...
#### Standardize facility names ([back to top](#costing-analyzer))
...
#### Clean Ages and Sex ([back to top](#costing-analyzer))
...
#### Standardize Times ([back to top](#costing-analyzer))
...
#### Count labs and prescriptions ([back to top](#costing-analyzer))
We wanted some aggregate counts of how many labs and prescriptions were given on a per visit basis.  *calcQuantities()* can be used to count all NA values in a set of *cols* (columns to modify) and then creates a new *col_name* in the dataframe. Remember, the dataframe is the implicit first argument for the function when using the compound assignment pipe. 
```{r}
...
#### Standardize Text Fields ([back to top](#costing-analyzer))
...
#### The easier way ([back to top](#costing-analyzer))
